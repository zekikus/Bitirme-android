...
public class DolapTipiListFragment extends Fragment{
    ...
    private List<DolapTipi> dolap_tipi_list;
    private int id_val;
    private String[] col_names = {"ad","aktifMi"};
    private String[] header_names = {"Adı: ","Aktif Mi: "};
